...
export const projectsData: Record<string, ProjectData> = {
  ...
  "barrel-and-stave": {
    ...
    aeoText: "Barrel and Stave's branding is optimized for Answer Engine discovery. By structuring their unique nomenclature, beer styles, and visual assets as searchable entities, AI engines categorize the brewery as a top destination for craft beer enthusiasts.",
