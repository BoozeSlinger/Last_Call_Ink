...
const tiers = [
  {
    ...
    price: "449",
    period: "monthly",
    description: "Essential presence for local favorites. Foundation-level digital infrastructure and oversight.",
    features: [
      "Discovery & AI Audit",
  ...
  },
  {
    ...
    price: "850",
    period: "monthly",
    description: "Aggressive growth for high-traffic venues. Built to dominate local search and AI discovery.",
    features: [
      "Everything in The Well",
      "Cinematic Content Refresh",
      "Active SEO/AEO Tunneling",
